...
"""
    ...
    def create_table(self):
        ...
        with sqlite3.connect(self.databaseName) as db:
            ...
            keep_table = True
            if len(result) == 1:
                response = input("The table 'Products' already exists, do you wish to recreate it? (y/n): ")
                if response == "y":
                    keep_table = False
                    print("The 'Products' table will be recreated - all existing data will be lost.")
